...
$(document).ready(function () {
    ...
    tabladata = $('#tbdata').DataTable({
        ...
        "columns": [
            { "data": "oSucursal", render: function (data) { return data.Nombre   } },
            { "data": "oSucursal", render: function (data) { return data.RFC   } },
            { "data": "oProducto", render: function (data) { return data.Codigo   } },
            { "data": "oProducto", render: function (data) { return data.Nombre   } },
            { "data": "Stock" },
            {
                "data": "ProductoSucursalID", "render": function (data, type, row, meta) {
...
function asignarProducto() {
    ...
    if ($("#txtsucursalid").val() == "0" || $("#txtproductoid").val() == "0")
        camposvacios = true;
    ...
    if (!camposvacios) {
        ...
        var request = {
            objeto: {
                oProducto: { ProductoID: parseInt($("#txtproductoid").val()) },
                oSucursal: { SucursalID: parseInt($("#txtsucursalid").val()) },
            }
        }

        jQuery.ajax({
            url: $.MisUrls.url._RegistrarProductoSucursal,
            type: "POST",
...
function eliminar($id) {
    ...
    swal({
        ...
        function () {
            jQuery.ajax({
                url: $.MisUrls.url._EliminarProductoSucursal + "?id=" + $id,
                type: "GET",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
