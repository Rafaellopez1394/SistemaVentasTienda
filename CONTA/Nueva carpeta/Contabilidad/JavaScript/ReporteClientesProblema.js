...
(function ($, balor, amplify) {
    ...
    */
    ...
    $('body').on('click', '#BotonImprimir', null, function () {
        var parametros = "&empresa=" + $('#ddl-empresa').val();
        parametros += "&fc=" + $("#fecha").val();
        parametros += "&ConSaldoDemandado=0"
        window.open("../../Base/Formas/ReporteProduccion.aspx?Formato=0&Nombre=SaldoClientesProblema" + parametros, 'w_PopSaldoCesionesBalor', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=760,height=560');
    });
