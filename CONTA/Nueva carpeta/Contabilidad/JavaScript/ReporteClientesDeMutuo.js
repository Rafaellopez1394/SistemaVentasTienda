(function ($, balor, amplify, moment) {
    ...
    var imprimir = function () {
        var parametros = "&empresaid=" + getEmpresaid();
        ...
        window.open("../../Base/Formas/ReporteProduccion.aspx?Formato=0&Nombre=ClientesMutuo" + parametros, 'w_PopClientesMutuo', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=760,height=560');
    };
    ...
    body.on('click', '#btnLimpiar', null, function () {
        window.location.replace('ReporteClientesDeMutuo.aspx');
    });
