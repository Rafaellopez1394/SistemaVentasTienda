<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportaContabilidadExcel.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ExportaContabilidadExcel" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="div_tituloPrincipal" class="content_header">
            <label class="lblTituloContenedor">Exportar Contabilidad Excel</label>
        </div>
            ...
            <div>
                <div class="inlineblock">
                    <fieldset>
                        ...
                        <label>
                            <input type="radio" name="timprimir" value="1" checked="checked" />
                            Excel</label>
                        <label>
                            <input type="radio" name="timprimir" value="3"/>
                            PDF</label>
                    </fieldset>
                </div>
            </div>
    ...
    <script src="../JavaScript/ExportaContabilidadExcel.js" type="text/javascript"></script>
