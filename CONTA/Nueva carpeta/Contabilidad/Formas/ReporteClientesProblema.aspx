<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteClientesProblema.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReporteClientesProblema" %>
...
<body>
    ...
    <div id="div_tituloPrincipal" class="content_header">
        <label class="lblTituloContenedor">Reporte de Clientes Problemas</label>
    </div>
    ...
    <script src="../JavaScript/ReporteClientesProblema.js" type="text/javascript"></script>
</body>
</html>
