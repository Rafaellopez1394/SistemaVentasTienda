<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteClientesDeMutuo.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReporteClientesDeMutuo" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="div_tituloPrincipal" class="content_header">
            <label class="lblTituloContenedor">Clientes de Mutuo</label>
        </div>
    ...
    <script src="../JavaScript/ReporteClientesDeMutuo.js"></script>
</body>
</html>
