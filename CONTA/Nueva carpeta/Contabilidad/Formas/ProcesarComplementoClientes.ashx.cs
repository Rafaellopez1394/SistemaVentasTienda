...
{
    /// <summary>
    /// Summary description for ProcesarComplementoClientes
    /// </summary>
    public class ProcesarComplementoClientes : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (context.Request.Files.Count > 0)
                {
                    ...
                    {
                        //Codigo para obtener el RFC del cliente directamente del xml
                        string xml = "";
                        string line;
                        ...
                        if (xml.Contains("<CFDI:EMISOR"))
                        {
                            ...
                            Entity.Analisis.Catcliente _cliente = MobileBO.ControlAnalisis.TraerCatclientesPorRfc(rfcEmisor);
                            if (_cliente == null)
                                throw new Exception("El cliente: " + rfcEmisor + " de la factura: " + context.Request.Files[i].FileName + " no existe en el sistema, debes registrarlo en el catalogo");
                            ...
                            directorio += "\\Clientes\\Complemento\\" + (Empresa.Empresa == 1 ? "Factur" : "Balor") + " \\" + DateTime.Today.Year.ToString() + "\\" + DateTime.Today.Month + "\\" + _cliente.Rfc;
                            ...
                            //Entity.ModeloRespuestaDIOT respuesta = MobileBO.DIOT.ValidaXML(saveLocation, true);
                            ...
                            //Entity.ModeloRespuestaDIOT respuesta = MobileBO.DIOT.ValidaXML(respuestaValidacion, saveLocation, true);
                            Entity.ModeloRespuestaDIOT respuesta = MobileBO.DIOT.ValidaXMLCliente(respuestaValidacion, saveLocation, true);
                            respuesta.Clienteid = _cliente.Clienteid;
