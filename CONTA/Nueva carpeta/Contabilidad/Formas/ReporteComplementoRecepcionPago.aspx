<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteComplementoRecepcionPago.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReporteComplementoRecepcionPago" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="div_tituloPrincipal" class="content_header">
            <label class="lblTituloContenedor">Complemento de recepción de pagos</label>
        </div>
    ...
    <script src="../JavaScript/ReporteComplementoRecepcionPago.js"></script>
</body>
</html>
