<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteGastosPersonales.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReporteGastosPersonales" %>
<!DOCTYPE html>
<html lang="es-mx">
...
<body>
    <form id="form1" runat="server">
      ...
      <div id="div_tituloPrincipal" class="content_header">
        <label class="lblTituloContenedor" >Reporte de Gastos Personales</label>
      </div>
  ...
  <script src="../JavaScript/ReporteGastosPersonales.js" type="text/javascript"></script>
</body>
</html>
