<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitudAltaCombustible.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.SolicitudAltaCombustible" %>
...
<head runat="server">
  ...
  <link href="../../Base/css/balor.css" rel="stylesheet">
    ...
    <link href="../Estilos/SocilitudAyudaCombustible.css" rel="stylesheet" />
  <!--[if lt IE 9]>
...
<body>
    <form id="form1" runat="server" novalidate>
      ...
      <div id="div_tituloPrincipal" class="content_header">
          <label class="lblTituloContenedor" >Solicitudes de apoyo para combustible</label>
      </div>
  ...
  <script src="../JavaScript/SolicitudAyudaCombustible.js"></script>
</body>
</html>
