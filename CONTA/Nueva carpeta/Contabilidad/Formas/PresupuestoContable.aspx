<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PresupuestoContable.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.PresupuestoContable" %>
...
<body>
    ...
    <div id="div_tituloPrincipal" class="content_header">
        <label class="lblTituloContenedor">Captura de Presupuestos Contable</label>
    </div>
    <div id="mainContainer" class="container_body">
        <div>
            ...
            <div>
                <div class="inlineblock">    
                    ...
                    <input type="button" id="btnConsultarSinEdicion" value="Consultar Sin Edicion" />                   
                </div>      
            </div>
        </div>
        <br />
        <div id="dviCuerpo">
            ...
            <div>
              <div class="inlineblock">
                <fieldset>
                    <legend>Tipo de impresion</legend>
                    <label><input type="radio" id="rdIndividual" name="TipoImpresion" value="1" checked />Individual</label>
                    <label><input type="radio" id="rdConsolidado" name="TipoImpresion" value="0" />Consolidado</label>
                </fieldset>
              </div>        
          </div>
    ...
    <input type="hidden" id="hdnAfecta" name="hdnAfecta" value="">
    ...
    <script src="../JavaScript/PresupuestoContable.js" type="text/javascript"></script>
</body>
</html>
