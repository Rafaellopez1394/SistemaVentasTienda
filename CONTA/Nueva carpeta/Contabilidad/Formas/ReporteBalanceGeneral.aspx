<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteBalanceGeneral.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReporteBalanceGeneral" %>
<!DOCTYPE html>
<html lang="es-mx">
...
<body>
    <form id="form1" runat="server">
      ...
      <div id="div_tituloPrincipal" class="content_header">
        <label class="lblTituloContenedor" >Reporte de Balance General</label>
      </div>
           ...
           <div>
                <div class="inlineblock">
                    <fieldset>
                        ...
                        <div>
                            <div class="inlineblock">
                                <label><input type="checkbox" id="chkCuentaDolares" />Unicamente cuentas de dolares</label>
                            </div>  
                        </div>
                    </fieldset>
                </div>
  ...
  <script src="../JavaScript/ReporteBalanceGeneral.js?v=1.0.1" type="text/javascript"></script>
</body>
</html>
