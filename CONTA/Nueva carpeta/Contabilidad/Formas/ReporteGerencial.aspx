<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteGerencial.aspx.cs"
    Inherits="BalorFinanciera.Contabilidad.Formas.ReporteGerencial" %>
...
<body>
    ...
    <div id="mainContainer" class="container_body">
        ...
        <div>
            <label for="chkAnexoCapitalInvertido" class="subtitulo"><input id="chkAnexoCapitalInvertido" type="checkbox" />Incluir anexo de capital invertido</label>
        </div>
        <div>
            <div class="inlineblock">
                <fieldset>
                    ...
                    <label>
                        <input type="radio" name="timprimir" value="0" checked />
                        PDF</label>
                    <label>
    ...
    <script src="../JavaScript/ReporteGerencial.js" type="text/javascript"></script>
</body>
</html>
