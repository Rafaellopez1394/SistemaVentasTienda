<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteSaldos.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReporteSaldos" %>
...
<body>
  <form id="form1" runat="server">
    ...
    <div id="div_tituloPrincipal" class="content_header">
        <label class="lblTituloContenedor">Reporte de Saldos</label>
    </div>
        <div>
            <h1>
                Empresa</h1>
...
<iframe id="myDownloaderFrame" style="display:none;" ></iframe>--%>
    ...
    <script src="../JavaScript/ReporteSaldos.js" type="text/javascript"></script>
</body>
</html>
