<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteIvaAcreditable.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReporteIvaAcreditable" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div id="div_tituloPrincipal" class="content_header">
        <label class="lblTituloContenedor" >Reporte Iva Acreditable</label>
      </div>
  ...
  <script src="../JavaScript/ReporteIvaAcreditable.js" type="text/javascript"></script>
</body>
</html>