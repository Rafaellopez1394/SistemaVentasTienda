<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteAuxiliarMayor.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReporteAuxiliarMayor" %>
<!DOCTYPE html>
<html lang="es-mx">
...
<body>
    <form id="form1" runat="server">
      ...
      <div id="div_tituloPrincipal" class="content_header">
        <label class="lblTituloContenedor" >Reporte Auxiliar de Mayor</label>
      </div>
  ...
  <script src="../JavaScript/ReporteAuxiliarMayor.js" type="text/javascript"></script>
</body>
</html>
