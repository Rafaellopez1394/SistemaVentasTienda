<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CapturaComplementoPagoCliente.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.CapturaComplementoPagoCliente" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="div_tituloPrincipal" class="content_header">
            <label class="lblTituloContenedor" >Recepción de Complementos de Pago Transportistas</label>
        </div>
    ...
    <script src="../JavaScript/CapturaComplementoPagoCliente.js" type="text/javascript"></script>
</body>
</html>
