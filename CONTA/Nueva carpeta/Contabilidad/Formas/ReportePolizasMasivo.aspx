<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportePolizasMasivo.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReportePolizasMasivo" %>
<!DOCTYPE html>
<html lang="es-mx">
...
<body>
    <form id="form1" runat="server">
      ...
      <div id="div_tituloPrincipal" class="content_header">
        <label class="lblTituloContenedor" >Impresion de pólizas</label>
      </div>
      ...
      <div>
          ...
          <div>
          <div class="inlineblock">
                  <label for="txtPolizaInicial">Póliza Inicial</label>
                        <input type="text" id="txtPolizaInicial" class="numerico derecha" maxlength="12" required />
                        </div>
                        <div class="inlineblock">
                        <label for="txtPolizaFinal">Póliza Final</label>
                        <input type="text" id="txtPolizaFinal" class="numerico derecha" maxlength="12" required />
             </div>
          </div>
        <footer>
  ...
  <script src="../JavaScript/ReportePolizasMasivo.js" type="text/javascript"></script>
</body>
</html>
