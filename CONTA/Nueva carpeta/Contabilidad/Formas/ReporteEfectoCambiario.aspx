<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteEfectoCambiario.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.ReporteEfectoCambiario" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div id="div_tituloPrincipal" class="content_header">
        <label class="lblTituloContenedor" >Reporte Efecto Cambiario</label>
      </div>
...
<%--             <div class="inlineblock">
  ...
  <script src="../JavaScript/ReporteEfectoCambiario.js" type="text/javascript"></script>
</body>
</html>