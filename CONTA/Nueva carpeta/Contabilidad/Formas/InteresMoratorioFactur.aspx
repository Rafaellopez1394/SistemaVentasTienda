<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InteresMoratorioFactur.aspx.cs" Inherits="BalorFinanciera.Contabilidad.Formas.InteresMoratorioFactur" %>
<!DOCTYPE html>
...
<body>
  <form id="form1" runat="server">
    ...
    <div id="div_tituloPrincipal" class="content_header">
      <label class="lblTituloContenedor" >Obtener Intereses de factur a una fecha</label>
    </div>
  ...
  <script src="../../Base/js/vendor/jquery-jtemplates-0.8.4.js"></script>
  ...
  <script src="../JavaScript/InteresMoratorioFactur.js"></script>
</body>
</html>
