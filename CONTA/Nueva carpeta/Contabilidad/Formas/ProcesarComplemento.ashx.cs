...
{
    /// <summary>
    /// Descripción breve de ProcesarComplemento
    /// </summary>
    public class ProcesarComplemento : IHttpHandler
    {
                ...
                if (context.Request.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < context.Request.Files.Count; i++)
                    {
                        ...
                        if (xml.Contains("<CFDI:EMISOR"))
                        {
                            ...
                            directorio += "\\Proveedores\\Complemento\\" + (Empresa.Empresa == 1 ? "Factur" : "Balor") + " \\" + DateTime.Today.Year.ToString() + "\\" + DateTime.Today.Month + "\\" + proveedor.Rfc;
