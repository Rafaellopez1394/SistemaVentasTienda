-- ================================================
-- Actualizar texto de recomendaciones en SP
-- Corrige: "perÃ­odo" a "periodo"
-- ================================================

USE DB_TIENDA;
GO

-- Recrear el stored procedure con texto corregido
...
PRINT 'Stored procedure actualizado - texto corregido sin acentos';
